...
- `configs/.csslintrc`
	- Configuration for the CSS linter, don't modify
- `configs/.scss-lint.yml`
	- Configuration for the SCSS linter, don't modify
...
The `fixes` directory contains one file: `pathname.rb`. For more info about it see [How to install](how-to-install.md)
